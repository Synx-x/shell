...
Item {
    ...
    readonly property list<int> focusedShapeList: [MaterialShape.Diamond]
    ...
    Loader {
        ...
        sourceComponent: LazyListView {
            ...
            delegate: Item {
                ...
                readonly property real iconSize: root.indSize * (iconSource ? Icons.getAppIconScale(appClass) : 1)
